...
class ProductDetails extends Component{
    ...
    componentDidMount() {
        ...
        fetch(`${base_url}/producto/${category}/${slug}`)
                    ...
                    <div className="ProductDetailsWrapper">
                        <div className="ProductDetailsImage">
                            ...
                            <div className="ActionButtonWrapper">
                                <button onClick={() => { this.addToCart(product._id, product.price, product.name, product.img) }}><i className="fas fa-shopping-cart"></i>&nbsp;ADD TO CART</button>
